...
— **your decision** (typed end-to-end, line-at-a-time streaming, no strings in the export pipeline). **Agent's choice** (LCE table, edge-aware preprocess, orbit-based tools, row-eraser fix that uses each orbit cell's own y).
