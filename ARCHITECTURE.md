...
- `src/index.js` — re-exports from `pkg/`; isolates consumers from wasm-pack output shape changes. — **Agent's choice**
- `src/index.d.ts` — TypeScript declarations; consumers never reference `pkg/` directly. — **Agent's choice**
