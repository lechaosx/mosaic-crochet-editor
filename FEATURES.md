...
- Crochet emits structured work units line-by-line with a generation counter and caches the direction-neutral plan until pattern geometry or cells change. Stitch edits preserve the numeric progress boundary. Open and New clear progress only when their incoming authored geometry or cells differ from the current chart. Returning to Design during generation cancels the unfinished plan. — **your decision** (cache and progress boundaries); **Agent's choice** (structured units and counter)
