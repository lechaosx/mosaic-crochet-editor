...
Scroll anywhere in the canvas area to zoom in/out. — **your decision (area); Agent's choice (scroll-to-zoom)**

---

## Canvas Rotation

Two buttons in the top-right of the toolbar rotate the canvas view ±45°. Rotation accumulates unbounded (no wrap-around) to avoid a fast reverse-spin when crossing 360°. Rotation persists across refreshes. — **your decision (feature, accumulation); Agent's choice (placement)**

---

## Pan

Middle-mouse drag pans the canvas freely. Pan resets to center when opening the New Pattern widget. Pan is not persisted across refreshes. — **your decision (reset on New); Agent's choice (middle-mouse)**
...
Touch events are mapped to drawing. — **Agent's choice**
