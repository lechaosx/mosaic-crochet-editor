...
- **Copy to clipboard** and **Download .txt** buttons. — **Agent's choice / your decision**
...
- **Save** — downloads the pattern as a `.mcw` file (JSON). On browsers with the File System Access API (Chrome/Edge), opens a native save dialog; on others downloads immediately. — **Agent's choice**
