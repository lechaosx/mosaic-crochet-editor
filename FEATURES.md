...
- Invalid or unsupported `.mcw` files report a persistent inline document error and leave the active session unchanged. Starting another load clears the previous error. — **Agent's choice**
