...
- Invalid or unsupported `.mcw` files report a dismissible inline document error and leave the active session unchanged. Starting another load clears the previous error; dismissal returns focus to Load or compact More. — **Agent's choice**
